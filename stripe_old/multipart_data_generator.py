...
class MultipartDataGenerator(object):
    ...
    def add_params(self, params):
        ...
        params = dict(stripe_old.api_requestor._api_encode(params))

        for key, value in stripe_old.six.iteritems(params):
            if value is None:
                continue
            ...
            if hasattr(value, "read"):
                ...
                if hasattr(value, "name"):
                    ...
                    filename = stripe_old.six.text_type(value.name)
    ...
    def _write(self, value):
        if isinstance(value, stripe_old.six.binary_type):
            array = bytearray(value)
        elif isinstance(value, stripe_old.six.text_type):
